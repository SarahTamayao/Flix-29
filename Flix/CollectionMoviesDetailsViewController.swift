//
//  CollectionMoviesDetailsViewController.swift
//  Flix
//
...
class CollectionMoviesDetailsViewController: UIViewController {
    ...
    @objc func didTap(sender: UITapGestureRecognizer) {
        ...
        performSegue(withIdentifier: "trailerSeque", sender: self)
